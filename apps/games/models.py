...
class Game(models.Model):
    ...
    user_1 = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_1_games')
    user_2 = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_2_games')
    # 랜덤으로 룰 지정
    RULE_CHOICES = [
        ('bigger', '큰 숫자가 이기는 룰'),
